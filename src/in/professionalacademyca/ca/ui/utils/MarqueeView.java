...
/* COMMENTED VIKALP AS HONEYCOMB NOT AVAILABE IN SDK
    ...
    private void extractAttributes(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.in_professionalacademyca_ca_ui_utils_MarqueeView);

        if (a == null) {
            return;
        }

        mSpeed = a.getInteger(R.styleable.in_professionalacademyca_ca_ui_utils_MarqueeView_speed, DEFAULT_SPEED);
        mAnimationPause = a.getInteger(R.styleable.in_professionalacademyca_ca_ui_utils_MarqueeView_pause, DEFAULT_ANIMATION_PAUSE);
        mAutoStart = a.getBoolean(R.styleable.in_professionalacademyca_ca_ui_utils_MarqueeView_autoStart, false);
...
//        mScrollView.addView(mTextField);
    ...
    private void initView(Context context) {
        // Scroll View
        LayoutParams sv1lp = new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        mScrollView.addView(mTextField, new ScrollView.LayoutParams(TEXTVIEW_VIRTUAL_WIDTH, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
